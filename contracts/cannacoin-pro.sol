...
contract Cannacoin is ERC20, Ownable {
    ...
    address public constant FEE_ADDRESS =
        0x8114BeC86C8F56c1014f590E05cD7826054EcBdE;

    // DEX Addresses
    address public constant PANGOLIN_FACTORY =
    ...
    address public constant TRADER_JOE_ROUTER =
        0x60aE616a2155Ee3d9A68541Ba4544862310933d4; // Replace with Trader Joe Router address
    address public constant YETISWAP_ROUTER =
        0x262DcFB36766C88E6A7a2953c16F8defc40c378A; // Replace with YetiSwap Router address

    event FeePaid(address indexed from, address indexed to, uint256 feeAmount);

    constructor(
        address initialOwner
    ) ERC20("Cannacoin PRO", "CPRO") Ownable(initialOwner) {
    ...
    function isDexTransaction(
        ...
        return
            sender == PANGOLIN_FACTORY ||
            recipient == PANGOLIN_FACTORY ||
