...
contract CannaCoinPro is ERC20, ReentrancyGuard, Ownable {
    ...
    address public constant FEE_ADDRESS = 0x3536b0152c91E60535508690a650C10bf09fe857;
    ...
    address public constant YETISWAP_ROUTER = 0x262DcFB36766C88E6A7a2953c16F8defc40c378A;

    event FeePaid(address indexed from, address indexed to, uint256 feeAmount);

    constructor() ERC20("CannacoinPRO", "CPRO") Ownable() {
        _mint(0x8114BeC86C8F56c1014f590E05cD7826054EcBdE, 1000000 * (10 ** decimals()));
        _mint(0x3536b0152c91E60535508690a650C10bf09fe857, 99000000 * (10 ** decimals()));
    }
